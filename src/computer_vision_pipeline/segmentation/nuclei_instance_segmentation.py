...
def segment_nuclei(dapi_im, cells_foreground_mask, nuclei_maskrcnn):
    """
    ...
    # combine the results
    nuclei_segmentation, nuclei_count = segment_nuclei_by_quarters(dapi_im, nuclei_maskrcnn)
    ...
    mask_per_nucleus_in_border, splitted_nuclei_indices = find_splitted_nuclei(dapi_im, nuclei_maskrcnn)
